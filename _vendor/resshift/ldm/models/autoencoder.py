...
except ImportError:  # only used when lora_tune_decoder=True (ResShift training); inference never does
    lora = None
...
from resshift.utils.util_common import instantiate_from_config
